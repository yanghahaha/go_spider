...
import (
	...
	"github.com/yanghahaha/go_spider/core/pipeline"
	"github.com/yanghahaha/go_spider/core/spider"
)
...
func main() {
	...
	spider.NewSpider(NewMyPageProcesser(), "TaskName").
		AddUrl("https://github.com/yanghahaha?tab=repositories", "html"). // Start url, html is the responce type ("html" or "json" or "jsonp" or "text")
